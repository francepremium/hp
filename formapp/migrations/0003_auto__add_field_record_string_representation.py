...
from formapp.models import make_string_representation


class Migration(SchemaMigration):

    def forwards(self, orm):
        # Adding field 'Record.string_representation'
        db.add_column('formapp_record', 'string_representation',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        for record in orm['formapp.Record'].objects.all():
            record.string_representation = make_string_representation(record)[:99]
            record.save()


    def backwards(self, orm):
        # Deleting field 'Record.string_representation'
        db.delete_column('formapp_record', 'string_representation')
    ...
    models = {
        ...
        'formapp.record': {
            'Meta': {'ordering': "('text_data',)", 'object_name': 'Record'},
            'data': ('jsonfield.fields.JSONField', [], {'default': '{}'}),
            'environment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['appstore.Environment']"}),
            'form': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['form_designer.Form']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'}),
            'string_representation': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
