...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RecordsWidget.maximum_values'
        db.delete_column('formapp_recordswidget', 'maximum_values')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'RecordsWidget.maximum_values'
        raise RuntimeError("Cannot reverse this migration. 'RecordsWidget.maximum_values' and its values cannot be restored.")
