...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('fusion_listcolumn', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('list', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fusion.List'])),
            ('widget', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['form_designer.Widget'])),
            ('order', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('fusion', ['ListColumn'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('fusion_listcolumn')
    ...
    models = {
        ...
        'fusion.list': {
            ...
            'columns': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['form_designer.Widget']", 'through': "orm['fusion.ListColumn']", 'symmetrical': 'False'}),
            'environment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['appstore.Environment']"}),
            'feature': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['appstore.AppFeature']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'fusion.listcolumn': {
            'Meta': {'ordering': "('order', 'list')", 'object_name': 'ListColumn'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'list': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['fusion.List']"}),
            'order': ('django.db.models.fields.IntegerField', [], {}),
            'widget': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['form_designer.Widget']"})
        },
        'taggit.tag': {
